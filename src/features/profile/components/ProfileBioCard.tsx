...
const ProfileBioCard: React.FC<ProfileBioCardProps> = ({ profileData }) => {
  const user = useAuth();
        ...
        <Box>
          ...
          >
            {profileData?.location && (
              <HStack>
                <Image src='./location.svg' alt='icon' />
            ...
            {profileData?.website && (
              <HStack cursor='pointer'>
                <Image src='personalWebsite.svg' alt='icon' />
                <Link
