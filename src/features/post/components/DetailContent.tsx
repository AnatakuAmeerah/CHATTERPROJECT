...
import Discussion from '../../comment/containers/Discussion';
import AllComments from '../../comment/containers/AllComments';
import { calcTotalDiscussion } from '../../comment/utils/CalculateTotal';
